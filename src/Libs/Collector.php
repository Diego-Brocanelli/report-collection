...
class Collector
{
    ...
    private $default_styles = [
        ...
        'border-color-inside'   => '#ccc',
        'border-color-outside'  => '#aaa',
    ...
    private $header_styles = [
        'background-color-odd'  => '#3B5998', // ímpar
        'background-color-even' => '#3B5998', // par
        'border-color-inside'   => '#133783',
        'border-color-outside'  => '#133783',
        'color'                 => '#ffffff',
    ];
     ...
     * @param string $use_default header|body|default
     * @return array
     */
    protected function normalizeStyles(array $styles, $use_default = 'default')
    {
        $defaults = ($use_default == 'default') 
            ? $this->default_styles
            : $this->getStyles($use_default);

        $clean_styles = [];

        // Baseia-se nos estilos padrões
